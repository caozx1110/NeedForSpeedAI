...
def pil_loader(data_path, label_path):
    """
    Load a sample and label image given their path as PIL images.
    The input is the path of the original image and the label
    """
...
def enet_weighing(dataloader, num_classes, c=1.02):
    """
    Compute class weights as described in the ENet paper:
...
def median_freq_balancing(dataloader, num_classes):
    """
    Compute class weights using median frequency balancing as described
